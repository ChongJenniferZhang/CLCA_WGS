...
export LOG_PATH=$CLCA_PROJECT_DIR/03_Signature/attribution/code/SBS96/01a_run_mSigAct_SBS96.log

nice singularity exec -e $CLCA_PROJECT_DIR/containers/signature.sif Rscript --vanilla $CLCA_PROJECT_DIR/03_Signature/attribution/code/SBS96/01a_run_mSigAct_SBS96.R $CLCA_PROJECT_DIR > $LOG_PATH 2>&1 &