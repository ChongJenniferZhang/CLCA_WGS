...
export LOG_PATH=$CLCA_PROJECT_DIR/signature/extraction/code/DBS78/01a_run_mSigHdp_DBS78.log

nice singularity exec -e $CLCA_PROJECT_DIR/container/signature.sif Rscript --vanilla $CLCA_PROJECT_DIR/signature/extraction/code/DBS78/01a_run_mSigHdp_DBS78.R $CLCA_PROJECT_DIR > $LOG_PATH 2>&1 &