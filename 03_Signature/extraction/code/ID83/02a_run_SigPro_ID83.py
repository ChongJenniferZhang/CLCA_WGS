...
if __name__ == "__main__":
  ...
  output_dir = project_dir+"/03_Signature/extraction/raw_output/ID83/SigProfilerExtractor/"
  ...
  input_catalog = project_dir+"/03_Signature/extraction/input/ID83/clca_catalog_ID83.txt"
