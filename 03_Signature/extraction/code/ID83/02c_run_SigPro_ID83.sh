...
export LOG_PATH=$CLCA_PROJECT_DIR/03_Signature/extraction/code/ID83/02a_run_SigPro_ID83.log

nice singularity exec -e $CLCA_PROJECT_DIR/containers/signature.sif python3.8 $CLCA_PROJECT_DIR/03_Signature/extraction/code/ID83/02a_run_SigPro_ID83.py $CLCA_PROJECT_DIR > $LOG_PATH 2>&1 &