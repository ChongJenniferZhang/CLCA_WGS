...
msighdp_sig_file <-
  "signature/extraction/raw_output/ID83/mSigHdp/extracted.signatures.csv"
msighdp_sig <-
...
sigpro_sig_file <-
  "signature/extraction/raw_output/ID83/SigProfilerExtractor/ID83_De-Novo_Signatures.txt"
sigpro_sig <-
...
# We also consider hdp.8 to be well supported because of the extremely high 
# Spearman correlation between the number of hdp.8 mutations and the number of 
# SBS_H3 (aflatoxin, Extended Data Fig. 3d-e). 
...
colnames(msighdp_sig_final) <- paste0("ID_H", 1:8)

ICAMS::WriteCatalog(
  catalog = msighdp_sig_final,
  file = "signature/extraction/summary/clca_signature_ID83.csv"
)
