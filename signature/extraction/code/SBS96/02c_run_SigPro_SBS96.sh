...
export LOG_PATH=$CLCA_PROJECT_DIR/signature/extraction/code/SBS96/02a_run_SigPro_SBS96.log

nice singularity exec -e $CLCA_PROJECT_DIR/container/signature.sif python3.8 $CLCA_PROJECT_DIR/signature/extraction/code/SBS96/02a_run_SigPro_SBS96.py $CLCA_PROJECT_DIR > $LOG_PATH 2>&1 &