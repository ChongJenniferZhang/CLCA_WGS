...
if __name__ == "__main__":
  ...
  output_dir = project_dir+"/signature/extraction/raw_output/ID83/SigProfilerExtractor/"
  ...
  input_catalog = project_dir+"/signature/extraction/input/ID83/clca_catalog_ID83.txt"
