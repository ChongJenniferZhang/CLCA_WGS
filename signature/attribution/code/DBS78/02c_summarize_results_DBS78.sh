...
export LOG_PATH=$CLCA_PROJECT_DIR/signature/attribution/code/DBS78/02a_summarize_results_DBS78.log

nice singularity exec -e $CLCA_PROJECT_DIR/container/signature.sif Rscript --vanilla $CLCA_PROJECT_DIR/signature/attribution/code/DBS78/02a_summarize_results_DBS78.R $CLCA_PROJECT_DIR > $LOG_PATH 2>&1 &