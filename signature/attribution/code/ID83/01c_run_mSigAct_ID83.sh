...
export LOG_PATH=$CLCA_PROJECT_DIR/signature/attribution/code/ID83/01a_run_mSigAct_ID83.log

nice singularity exec -e $CLCA_PROJECT_DIR/container/signature.sif Rscript --vanilla $CLCA_PROJECT_DIR/signature/attribution/code/ID83/01a_run_mSigAct_ID83.R $CLCA_PROJECT_DIR > $LOG_PATH 2>&1 &